...
\subsection{The choice of the final classification with the ratio index and the Silhouette plot} \label{sect:silhouette}
...
The function returns the value of the ratio index varying $k$ for
